...
function TWaterMaterialAppearance() {
...
function updateTWaterMaterial(appearance) {
    appearance.material.uniforms.iTime += 0.01;
}

export { TWaterMaterialAppearance, updateTWaterMaterial }
