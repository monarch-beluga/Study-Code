...
namespace Map_GIS
{
    ...
    public class CreateNewDocument : BaseCommand
    {
        ...
        public CreateNewDocument()
        {
            ...
            base.m_bitmap = new Bitmap(Common.AppStartPath + "/resource/DocumentNew16.png");
        }
        ...
        public override void OnClick()
        {
            ...
            {
                result = MessageBox.Show("是否保存当前编辑？", "Save Edits", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            ...
            DialogResult res = MessageBox.Show("是否保存当前文档?", "AoView", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
