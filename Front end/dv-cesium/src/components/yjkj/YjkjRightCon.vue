...
import YjkjRightConBox from "./YjkjRightConBox.vue";
import {ref} from "vue";

const yjkjRightConBox = ref(null)
function mapDataChange(index){
  yjkjRightConBox.value.getYjkjData(index)
}
defineExpose({mapDataChange})
...
<div class="right-container">
  <div class="data box h0 flex-1">
    <div class="title-box">
      <div class="title">应急空间信息</div>
    </div>
    <div class="context-box">
      <YjkjRightConBox ref="yjkjRightConBox"></YjkjRightConBox>
    </div>
  </div>
</div>
</template>
